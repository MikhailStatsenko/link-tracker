...
class JdbcLinkRepositoryTest extends IntegrationTest {
    ...
    public static void setUp() {
        ...
        link1 = new Link(URI.create("https://github.com/user1/example"));
        link2 = new Link(URI.create("https://github.com/user2/example"));
        link3 = new Link(URI.create("https://stackoverflow.com/questions/123/what-is-question"));
    }
    ...
    public void testFindAllOutdatedLinks() {
        link1.setLastCheckTime(OffsetDateTime.now());
        ...
        assertThat(foundLinks.size()).isEqualTo(0);
        foundLinks = jdbcLinkRepository.findAllOutdatedLinks(0);
        assertThat(foundLinks.stream().map(Link::getUrl).toList())
