...
public class LinkRecord extends UpdatableRecordImpl<LinkRecord> implements Record3<Integer, String, OffsetDateTime> {
    ...
    @Override
    @NotNull
    public LinkRecord values(@Nullable Integer value1, @NotNull String value2, @Nullable OffsetDateTime value3) {
        value1(value1);
        value2(value2);
        value3(value3);
        return this;
    ...
    public LinkRecord(@Nullable Integer id, @NotNull String url, @Nullable OffsetDateTime lastCheckTime) {
        super(Link.LINK);
